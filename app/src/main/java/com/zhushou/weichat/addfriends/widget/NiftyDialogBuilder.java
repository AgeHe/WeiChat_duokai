...
import com.zhushou.weichat.addfriends.animation.BaseEffects;
...
//					instance = new NiftyDialogBuilder(context,R.style.dialog_untran);
	...
	private void init(Context context) {
		...
		mNextCustomLayout = (FrameLayout) mDialogView.findViewById(R.id.fl_custom_next_layout);
		mNextCustomLayout.setVisibility(View.GONE);
		mTitle = (TextView) mDialogView.findViewById(R.id.alertTitle);
		mMessage = (TextView) mDialogView.findViewById(R.id.message);
		mPreviousLayout = (FrameLayout) mDialogView.findViewById(R.id.fl_dialog_title_previous);
		mIcon = (ImageView) mDialogView.findViewById(R.id.icon);
		mPreviousText = (TextView) mDialogView.findViewById(R.id.tv_dialog_title_previous_text);
		mNextLayout = (FrameLayout) mDialogView.findViewById(R.id.fl_dialog_title_next);
		mNextLayout.setVisibility(View.VISIBLE);
		mNextImage = (ImageView) mDialogView.findViewById(R.id.iv_dialog_title_next_img);
		mNextText = (TextView) mDialogView.findViewById(R.id.tv_dialog_title_next_text);
