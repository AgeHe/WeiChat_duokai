...
public class ComplaintsOrderNumberActivity extends BaseActivity {

    private static final String TAG = "ComplaintsOrderNumberActivity";
    ...
    EditText et_order_number,et_phone_number;
    @Override
