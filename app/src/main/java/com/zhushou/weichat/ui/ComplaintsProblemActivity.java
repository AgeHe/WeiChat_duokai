...
public class ComplaintsProblemActivity extends BaseActivity {

    private static final String TAG = "ComplaintsProblemActivity";
    ...
    EditText et_phone_number,et_complaints_content;
    @Override
    ...
    protected void viewOnClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.tv_complaints_submit:
                ...
                if (et_complaints_content.getText().equals("")){
                ...
                hashMap.put("description",et_complaints_content.getText().toString());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:
                    ...
                    Log.i(TAG, "handleMessage: msg="+okHttpResult.msg);
                    if (okHttpResult.isSuccess){
                        et_phone_number.setText("");
                        et_complaints_content.setText("");
