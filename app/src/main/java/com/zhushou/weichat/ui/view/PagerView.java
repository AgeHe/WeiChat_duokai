...
import com.zhushou.weichat.ui.adapter.PagerAdapter;
...
public class PagerView extends ViewGroup implements PagerAdapter.OnDataChangeListener {
	...
	public void setBottomLine(int bottomLine,int leftLine) {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		if (mode == MODE_DRAG || mode == MODE_SCROLL) {
			Log.i(TAG, "onInterceptTouchEvent: "+(mode==MODE_DRAG?"MODE_DRAG":"MODE_SCROLL"));
			return true;
		}else{
	...
	private void onDrag(int x, int y) {
		...
		isUnderBottomLine = y + dragBitmap.getHeight() > bottomLine&&x + dragBitmap.getWidth() > leftLine;
		if (y + dragBitmap.getHeight() > bottomLine&&x + dragBitmap.getWidth() > leftLine){
			Log.i("hh", "onDrag: ");
		}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		setBackground(new PagerViewDrawable(mContext,childWidth,childHeight));
	}
